    ...
    <PublicContainer>
      ...
      <section className="space-y-16 container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
        ...
        <div className="text-center">
          <Avatar className="inline-block h-48 mb-5" />
          <h3 className="text-lg md:text-xl md:leading-relaxed font-medium text-gray-600 lg:w-2/3 mx-auto">
            We are a passionate team who are here to help you distribute music and build your audience &amp; impact
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          ...
          <div>
            ...
            <p className="leading-relaxed text-gray-600">
              We believe that design should be invisible and enhance the user experience, not get in the way. This gives
              room for your content to breath and attracts your users’ attention.
            </p>
          </div>
        </div>
        {/* END Values */}
