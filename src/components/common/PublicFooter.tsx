...
import { __PHONE_NUMBER__ } from '~constants';
import { RoutesDict } from '~lib/RoutesDict';

interface IPublicFooterProps {}

export const PublicFooter: React.FC<IPublicFooterProps> = () => {
  return (
    <footer className="bg-white">
      <div className="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="space-y-6">
            <h4 className="text-sm uppercase font-semibold tracking-wider text-gray-400">Company</h4>
            <nav className="flex flex-col space-y-3">
              <a href={RoutesDict.public.welcome} className="font-medium text-gray-600 hover:text-gray-500">
                Home
              </a>
              <a href={RoutesDict.public.features} className="font-medium text-gray-600 hover:text-gray-500">
                Features
              </a>
              <a href={RoutesDict.public.pricing} className="font-medium text-gray-600 hover:text-gray-500">
                Pricing Plans
              </a>
              <a href={RoutesDict.public.contact} className="font-medium text-gray-600 hover:text-gray-500">
                Contact
              </a>
              <a href={RoutesDict.public.about} className="font-medium text-gray-600 hover:text-gray-500">
                About
              </a>
            </nav>
          </div>
          <div className="space-y-6">
            <h4 className="text-sm uppercase font-semibold tracking-wider text-gray-400">Legal</h4>
            <nav className="flex flex-col space-y-3">
          ...
          <div className="space-y-6">
            ...
            <div className="text-sm leading-relaxed">
              ...
              Kalanaur, IN 143512
              <br />
              <abbr title="Phone">Ph:</abbr> {__PHONE_NUMBER__}
            </div>
            <h4 className="text-sm uppercase font-semibold tracking-wider text-gray-400">Join Our Newsletter</h4>
        ...
        <div className="flex flex-col md:flex-row-reverse md:justify-between space-y-6 md:space-y-0 text-center md:text-left text-sm">
          ...
          <div className="text-gray-500">
            <span className="font-medium">Mehra Records Entertainment</span> © {new Date().getFullYear()}
          </div>
        </div>
      </div>
    </footer>
