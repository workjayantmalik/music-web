...
export const data = {
  labels: ['Facebook', 'Gaana', 'Jio Saavan', 'Resso', 'Spotify', 'Wynk', 'Others'],
  datasets: [
    {
      label: 'Platform',
    ...
    <section className="flex flex-col rounded shadow-sm bg-white overflow-hidden mb-5">
      ...
      <div className="py-4 px-5 lg:px-6 w-full bg-gray-50 sm:flex sm:justify-between sm:items-center">
        <div className="text-center sm:text-left">
          ...
          <h4 className="text-gray-500 text-sm">A simple and clean interface to monitor your platforms.</h4>
        </div>
